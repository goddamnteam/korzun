...
Финальные правки:
- 1 слайд: дата [DONE]
- 3 слайд: регулярку привести к виду a++a+, где плюсы справа от символа 'а' будут как бы в степени [DONE]
- 8 слайд: в достигнутые символы добавить символ '+' [DONE]
- 11 слайд: укоротить фразу на какую-нибудь тип "ненулевая цепочка символов 'a'" [DONE]
- 12 слайд: справа aa+a изменить на a+aa [DONE]
- 13 слайд: объяснить, что означает красный цвет [DONE]
- добавить на все слайды короткие заголовки для ориентирования [DONE]
- удалить 6 слайд (вместо него есть 7 слайд с алгоритмом). [DONE]
