...
Финальные правки:
- 1 слайд: дата
- 3 слайд: регулярку привести к виду a++a+, где плюсы справа от символа 'а' будут как бы в степени
- 8 слайд: в достигнутые символы добавить символ '+'
- 11 слайд: укоротить фразу на какую-нибудь тип "ненулевая цепочка символов 'a'"
- 12 слайд: справа aa+a изменить на a+aa
- 13 слайд: объяснить, что означает красный цвет
- добавить на все слайды короткие заголовки для ориентирования
- удалить 6 слайд (вместо него есть 7 слайд с алгоритмом).
